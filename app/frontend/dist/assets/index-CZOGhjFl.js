const __vite__fileDeps = [
		'assets/Home-ChQkjNgz.js',
		'assets/Button-5ZxX_AXj.js',
		'assets/Home-gPRlgOuG.css',
		'assets/Chat-CUr8ITtm.js',
		'assets/Header-3Ry2d7os.js',
		'assets/Header-BttNdh6z.css',
		'assets/Chat-CGDS9nIT.css',
		'assets/Game-CUSY7UDX.js',
		'assets/Game-D2IuVXtf.css',
		'assets/Custom-C6aLXnUB.js',
		'assets/Custom-BCdiJNlB.css',
		'assets/Profile-BPmPuw3m.js',
		'assets/Profile-BM9u8CXQ.css',
		'assets/Settings-BBqUS_G9.js',
		'assets/Settings-E_azy7Pe.css',
		'assets/Dashboard-BuvOrz8g.js',
		'assets/Dashboard-B6lAjyqF.css',
	],
...
function zr(e, t, n, r, l) {
	...
	if (((i = 0), (r = r === '' ? '.' : r + ':'), ru(e)))
		...
		for (e = s.call(e), u = 0; !(o = e.next()).done; )
			(o = o.value), (s = r + Ml(o, u++)), (i += zr(o, t, n, s, l));
	else if (o === 'object')
		throw (
			((t = String(e)),
			Error(
...
var _ = Ss.exports;
const De = Hc(_),
	uf = Wc({ __proto__: null, default: De }, [_]);
/**
 * @license React
 ...
 */ var sf = _,
	...
	df =
		sf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
 ...
 */ (function (e) {
	...
	function k(C, R) {
		...
		try {
			for (
				d(R), h = n(s);
				h !== null && (!(h.expirationTime > R) || (C && !Le()));
			...
			if (h !== null) var fr = !0;
				...
				var Et = n(a);
				Et !== null && Il(v, Et.startTime - R), (fr = !1);
			}
			return fr;
		} finally {
			(h = null), (m = z), (y = !1);
			...
			return (
				...
				z > Q
					? ((C.sortIndex = z),
						...
						n(s) === null &&
							C === n(a) &&
							(w ? (f(L), (L = -1)) : (w = !0), Il(v, z - Q)))
					: ((C.sortIndex = J), t(s, C), g || y || ((g = !0), Ol(k))),
				C
			);
		}),
...
function on(e, t) {
	for (Bn[e] = t, e = 0; e < t.length; e++) Is.add(t[e]);
}
var Xe = !(
		typeof window > 'u' ||
...
var qe = mf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Nf(e, t, n, r, l, o, i, u, s) {
	(On = !1), (Wr = null), _f.apply(Pf, arguments);
}
function Lf(e, t, n, r, l, o, i, u, s) {
	if ((Nf.apply(this, arguments), On)) {
		if (On) {
			var a = Wr;
			(On = !1), (Wr = null);
...
var Ie = Math.clz32 ? Math.clz32 : Ff,
	...
	Df = Math.LN2;
function Ff(e) {
	return (e >>>= 0), e === 0 ? 32 : (31 - ((Mf(e) / Df) | 0)) | 0;
}
var yr = 64,
	gr = 4194304;
function Rn(e) {
...
function Or(e) {
	...
	for (var t = e.targetContainers; 0 < t.length; ) {
		...
		} else return (t = sr(n)), t !== null && gi(t), (e.blockedOn = n), !1;
		t.shift();
	}
	return !0;
}
...
function wi(e, t, n, r) {
	if (Yr) {
		var l = Lo(e, t, n, r);
		if (l === null) Zl(e, t, r, Xr, n), mu(e, r);
		else if (Vf(l, e, t, n, r)) r.stopPropagation();
		else if ((mu(e, r), t & 4 && -1 < Af.indexOf(e))) {
			for (; l !== null; ) {
				var o = sr(l);
				if (
					(o !== null && la(o),
					(o = Lo(e, t, n, r)),
					o === null && Zl(e, t, r, Xr, n),
					o === l)
				)
					break;
				l = o;
...
var Xr = null;
function Lo(e, t, n, r) {
	if (((Xr = null), (e = mi(r)), (e = Pt(e)), e !== null))
...
var hn = {
	...
	vl = A({}, ur, {
		...
		movementX: function (e) {
			return 'movementX' in e
				...
				: (e !== xn &&
						(xn && e.type === 'mousemove'
							? ((Al = e.screenX - xn.screenX),
								(Vl = e.screenY - xn.screenY))
							: (Vl = Al = 0),
						(xn = e)),
					Al);
		},
	...
	gu = ke(vl),
	Yf = A({}, vl, { dataTransfer: 0 }),
	Xf = ke(Yf),
	Gf = A({}, ur, { relatedTarget: 0 }),
	Wl = ke(Gf),
	Zf = A({}, hn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
	Jf = ke(Zf),
	qf = A({}, hn, {
...
var od = A({}, ur, {
	...
	ad = ke(sd),
	cd = A({}, hn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
	fd = ke(cd),
	dd = A({}, vl, {
		deltaX: function (e) {
			return 'deltaX' in e
	...
	pd = ke(dd),
	hd = [9, 13, 27, 32],
	xi = Xe && 'CompositionEvent' in window,
	In = null;
Xe && 'documentMode' in document && (In = document.documentMode);
var md = Xe && 'TextEvent' in window && !In,
	fa = Xe && (!xi || (In && 8 < In && 11 >= In)),
	ku = ' ',
	Eu = !1;
function da(e, t) {
	switch (e) {
...
function yd(e, t) {
	if (Wt)
		return e === 'compositionend' || (!xi && da(e, t))
			? ((e = ca()), (Ir = Si = lt = null), (Wt = !1), e)
			: null;
	switch (e) {
		case 'paste':
			return null;
...
if (Xe) {
	...
	ma = Hl && (!document.documentMode || 9 < document.documentMode);
}
function _u() {
	jn && (jn.detachEvent('onpropertychange', va), (Kn = jn = null));
}
function va(e) {
	if (e.propertyName === 'value' && yl(Kn)) {
		var t = [];
		ha(t, Kn, e, mi(e)), Gs(wd, t);
	}
}
function kd(e, t, n) {
	e === 'focusin'
		? (_u(), (jn = t), (Kn = n), jn.attachEvent('onpropertychange', va))
		: e === 'focusout' && _u();
}
function Ed(e) {
...
function gl(e) {
	...
	var t = Qt[e],
		n;
	for (n in t) if (t.hasOwnProperty(n) && n in wa) return (Kl[e] = t[n]);
	return e;
}
var Sa = gl('animationend'),
...
for (var Yl = 0; Yl < Ru.length; Yl++) {
	var Xl = Ru[Yl],
		Ld = Xl.toLowerCase(),
		Rd = Xl[0].toUpperCase() + Xl.slice(1);
	gt(Ld, 'on' + Rd);
}
...
function _a(e, t) {
	...
	if (Hr) throw ((e = _o), (Hr = !1), (_o = null), e);
}
function D(e, t) {
	var n = t[Mo];
			...
			e: {
				...
				if (
					...
					if (
						...
						t: {
							for (w = y, f = g, c = 0, d = w; d; d = Bt(d)) c++;
...
var jo = typeof setTimeout == 'function' ? setTimeout : void 0,
	...
	jd =
		typeof queueMicrotask == 'function'
			...
			: typeof Iu < 'u'
				? function (e) {
						return Iu.resolve(null).then(e).catch(Md);
					}
				: jo;
function Md(e) {
	setTimeout(function () {
...
var mn = Math.random().toString(36).slice(2),
	$e = '__reactFiber$' + mn,
	Zn = '__reactProps$' + mn,
	Ge = '__reactContainer$' + mn,
	Mo = '__reactEvents$' + mn,
	Dd = '__reactListeners$' + mn,
...
function St() {
	if (!ql && He !== null) {
		...
		try {
			...
			throw (He !== null && (He = He.slice(e + 1)), bs(vi, St), l);
		} finally {
			(j = t), (ql = !1);
		}
	}
...
function Ra(e, t, n) {
	(Ee[xe++] = Qe), (Ee[xe++] = Ke), (Ee[xe++] = Ot), (Ot = e);
	var r = Qe;
	e = Ke;
	var l = 32 - Ie(r) - 1;
	(r &= ~(1 << l)), (n += 1);
...
var $d = qe.ReactCurrentBatchConfig;
function Cn(e, t, n) {
	if (
		((e = n.ref),
...
function Oa(e) {
	...
	function m(f, c, d, v) {
		...
		if (typeof d == 'object' && d !== null) {
			...
			if (Ln(d) || wn(d)) return k !== null ? null : p(f, c, d, v, null);
			_r(f, d);
		}
		return null;
	}
	function y(f, c, d, v, k) {
		...
		if (typeof v == 'object' && v !== null) {
			...
			if (Ln(v) || wn(v))
				return (f = f.get(d) || null), p(c, f, v, k, null);
			_r(c, v);
		}
		return null;
	}
	function g(f, c, d, v) {
		...
		if (L === d.length) return n(f, N), U && Ct(f, L), k;
		if (N === null) {
			for (; L < d.length; L++)
				(N = h(f, d[L], v)),
					N !== null &&
	...
	function w(f, c, d, v) {
		...
		if (O.done) return n(f, N), U && Ct(f, L), k;
		if (N === null) {
...
function Ii(e, t) {
	switch ((M(qn, t), M(Jn, e), M(Ae, ar), (e = t.nodeType), e)) {
		case 9:
		case 11:
...
function Fi(e, t, n, r, l, o) {
	if (
		...
		(t.updateQueue = null),
		(t.lanes = 0),
		(Dr.current = e === null || e.memoizedState === null ? Hd : Qd),
		(e = n(r, l)),
		Dn)
	) {
		o = 0;
...
function to(e) {
	...
	if (((e = n.interleaved), e !== null)) {
		l = e;
		do (o = l.lane), (B.lanes |= o), (jt |= o), (l = l.next);
		while (l !== e);
...
function Ua(e, t) {
	...
	if (
		...
		(r = r.queue),
		$i(Aa.bind(null, n, r, e), [e]),
		r.getSnapshot !== t || o || (q !== null && q.memoizedState.tag & 1))
	) {
		if (
			((n.flags |= 2048),
			tr(9, Ba.bind(null, n, r, l, t), void 0, null),
			b === null)
		)
			throw Error(S(349));
		It & 30 || $a(n, t, l);
...
function Ja(e, t, n) {
	return It & 21
		? (Me(n, t) ||
				((n = na()), (B.lanes |= n), (jt |= n), (e.baseState = !0)),
			t)
...
function Wd(e, t, n) {
	...
	if (ba(e)) ec(t, l);
		...
		(n = ja(e, t, l, r)),
			n !== null && ((l = se()), je(n, e, r, l), tc(n, t, r));
	}
}
function ba(e) {
	var t = e.alternate;
	...
	Hd = {
		...
		useImperativeHandle: function (e, t, n) {
			return (
				...
				Fr(4194308, 4, Ya.bind(null, t, e), n)
			);
		},
		...
		useSyncExternalStore: function (e, t, n) {
			...
			return (
				(l.queue = o),
				Wu(Aa.bind(null, r, o, e), [e]),
				(r.flags |= 2048),
				tr(9, Ba.bind(null, r, o, n, t), void 0, null),
				n
			);
		},
		useId: function () {
...
function Ao(e, t, n, r) {
	...
	typeof o == 'object' && o !== null
		? (l.context = Pe(o))
		: ((o = he(t) ? Tt : ie.current), (l.context = un(e, o))),
...
var Xd = qe.ReactCurrentOwner,
	de = !1;
function ue(e, t, n, r) {
	t.child = e === null ? Ia(t, null, n, r) : an(t, e.child, n, r);
}
	...
	return (
		...
		e !== null && !de
			? ((t.updateQueue = e.updateQueue),
				...
				(e.lanes &= ~l),
				Je(e, t, l))
			: (U && n && _i(t), (t.flags |= 1), ue(e, t, r, l), t.child)
	);
}
	...
	return (
		...
		e !== null && !de
			? ((t.updateQueue = e.updateQueue),
				...
				(e.lanes &= ~l),
				Je(e, t, l))
			: (U && r && _i(t), (t.flags |= 1), ue(e, t, n, l), t.child)
	);
}
function Ju(e, t, n, r, l) {
	...
	if ((rn(t, l), t.stateNode === null))
		Ur(e, t), nc(t, n, r), Ao(t, n, r, l), (r = !0);
	else if (e === null) {
		var i = t.stateNode,
			u = t.memoizedProps;
		i.props = u;
		...
		u !== h || m !== g || pe.current || tt
			? (typeof y == 'function' &&
					(Bo(t, n, y, r), (g = t.memoizedState)),
				(a = tt || Hu(t, n, a, r, m, g, s) || !1)
					? (p ||
...
function Ho(e, t, n, r, l, o) {
	uc(e, t);
	var i = (t.flags & 128) !== 0;
	if (!r && !i) return l && Du(t, n, !1), Je(e, t, o);
...
function Gd(e, t, n, r, l, o, i) {
	if (n)
		return t.flags & 256
			? ((t.flags &= -257), (r = ro(Error(S(422)))), Pr(e, t, i, r))
			: t.memoizedState !== null
	...
	if (l.data === '$!') {
		...
		return (
			(r = u), (o = Error(S(419))), (r = ro(o, r, void 0)), Pr(e, t, i, r)
		);
	}
	if (((u = (i & e.childLanes) !== 0), de || u)) {
		if (((r = b), r !== null)) {
			...
			(l = l & (r.suspendedLanes | i) ? 0 : l),
				l !== 0 &&
					l !== o.retryLane &&
					((o.retryLane = l), Ze(e, l), je(r, e, l, -1));
		}
		return Yi(), (r = ro(Error(S(421)))), Pr(e, t, i, r);
	}
	return l.data === '$?'
		? ((t.flags |= 128),
			(t.child = e.child),
	...
	switch ((Pi(t), t.tag)) {
		...
		case 5:
			...
			if (((n = t.type), e !== null && t.stateNode != null))
				...
				if (((e = Lt(Ae.current)), Cr(t))) {
					(r = t.stateNode), (n = t.type);
					var o = t.memoizedProps;
					switch (
						((r[$e] = t), (r[Zn] = o), (e = (t.mode & 1) !== 0), n)
					) {
						case 'dialog':
		...
		case 6:
			if (e && t.stateNode != null) pc(e, t, e.memoizedProps, r);
				...
				if (typeof r != 'string' && t.stateNode === null)
					throw Error(S(166));
				if (((n = Lt(qn.current)), Lt(Ae.current), Cr(t))) {
					if (
						((r = t.stateNode),
						(n = t.memoizedProps),
						(r[$e] = t),
...
function ep(e, t) {
	...
	for (
		Oo = { focusedElem: e, selectionRange: n }, Yr = !1, x = t;
		x !== null;
...
function yc(e, t) {
	...
	switch (e.tag) {
		...
		case 15:
			...
			break;
		case 1:
			Re(t, e), Fe(e), r & 512 && n !== null && Jt(n, n.return);
			break;
		case 5:
			if (
				(Re(t, e),
		...
		? I & 2 && te !== 0
			...
			: $d.transition !== null
				...
				: ((e = j),
					e !== 0 ||
						((e = window.event),
						(e = e === void 0 ? 16 : aa(e.type))),
					e)
		: 1;
}
function je(e, t, n, r) {
	if (50 < $n) throw (($n = 0), (bo = null), Error(S(185)));
	ir(e, n, r),
		(!(I & 2) || e !== b) &&
			(e === b && (!(I & 2) && (Cl |= n), Z === 4 && rt(e, te)),
			me(e, r),
			n === 1 &&
				I === 0 &&
				!(t.mode & 1) &&
...
function wc(e, t) {
	...
	if (r & 30 || r & e.expiredLanes || t) t = cl(e, r);
		...
		I |= 2;
		var o = kc();
		(b !== e || te !== t) && ((We = null), (dn = K() + 500), Rt(e, t));
		do
			try {
				op();
				break;
	...
	if (t !== 0) {
		if (
			(t === 2 && ((l = Po(e)), l !== 0 && ((r = l), (t = ei(e, l)))),
			t === 1)
		)
			throw ((n = nr), Rt(e, 0), rt(e, r), me(e, K()), n);
		if (t === 6) rt(e, r);
		else {
			if (
			...
			switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
				...
				case 3:
					if (
						...
						e.timeoutHandle = jo(_t.bind(null, e, fe, We), t);
						break;
					}
					_t(e, fe, We);
					break;
				case 4:
					...
					if (
						...
						e.timeoutHandle = jo(_t.bind(null, e, fe, We), r);
						break;
					}
					_t(e, fe, We);
					break;
...
function is(e) {
	...
	if (n === 1) throw ((n = nr), Rt(e, 0), rt(e, t), me(e, K()), n);
...
function Mt(e) {
	...
	try {
		...
		(j = r), (_e.transition = n), (I = t), !(I & 6) && St();
	}
}
function Ki() {
	(ve = qt.current), F(qt);
...
function Yi() {
	(Z === 0 || Z === 3 || Z === 2) && (Z = 4),
		b === null || (!(jt & 268435455) && !(Cl & 268435455)) || rt(b, te);
}
function cl(e, t) {
	var n = I;
	I |= 2;
	...
	while (!0);
	if ((Ri(), (I = n), (ul.current = r), Y !== null)) throw Error(S(261));
...
function _t(e, t, n) {
	var r = j,
		l = _e.transition;
	try {
		(_e.transition = null), (j = 1), ip(e, t, n, r);
	} finally {
		(_e.transition = l), (j = r);
	}
	return null;
...
function ln() {
	if (ot !== null) {
		var e = ra(al),
			...
			n = j;
		try {
			if (((_e.transition = null), (j = 16 > e ? 16 : e), ot === null))
				var r = !1;
			else {
				if (((e = ot), (ot = null), (al = 0), I & 6))
					throw Error(S(331));
				var l = I;
...
_c = function (e, t, n) {
	...
	else (de = !1), U && t.flags & 1048576 && Ra(t, el, t.index);
	switch (((t.lanes = 0), t.tag)) {
		case 2:
			var r = t.type;
			Ur(e, t), (e = t.pendingProps);
			var l = un(t, ie.current);
			rn(t, n), (l = Fi(null, t, r, e, l, n));
			var o = Ui();
			return (
				(t.flags |= 1),
				typeof l == 'object' &&
			...
			e: {
				...
				if (((r = i.element), o.isDehydrated))
					if (
						...
						(l = fn(Error(S(423)), t)), (t = qu(e, t, r, n, l));
						break e;
					} else if (r !== l) {
						(l = fn(Error(S(424)), t)), (t = qu(e, t, r, n, l));
						break e;
					} else
						for (
...
function mp(e, t, n, r, l) {
	...
	var s = Gi(e, 0, !1, null, null, !1, !1, '', as);
	return (
...
Ys = Qi;
Xs = Mt;
var vp = { usingClientEntryPoint: !1, Events: [sr, Kt, wl, Qs, Ks, Qi] },
	Pn = {
...
var gp = zs.exports,
	cs = gp;
(so.createRoot = cs.createRoot), (so.hydrateRoot = cs.hydrateRoot);
...
function xp(e, t, n, r) {
	...
	let w = {
		...
		listen(E) {
			...
			return (
				l.addEventListener(ds, h),
				(s = E),
				() => {
					l.removeEventListener(ds, h), (s = null);
				}
			);
		},
		createHref(E) {
...
function Oc(e, t, n, r) {
	...
	let l = (o, i, u) => {
		...
		o.children &&
			...
			Oc(o.children, t, p, a)),
			!(o.path == null && !o.index) &&
				t.push({ path: a, score: Op(a, o.index), routesMeta: p });
	};
	return (
		e.forEach((o, i) => {
			var u;
			if (o.path === '' || !((u = o.path) != null && u.includes('?')))
				l(o, i);
			else for (let s of Ic(o.path)) l(o, i, s);
		}),
		t
	);
}
...
function Op(e, t) {
	...
	return (
		...
		n
			.filter((l) => !ms(l))
			.reduce((l, o) => l + (Pp.test(o) ? Np : o === '' ? Rp : zp), r)
	);
}
function Ip(e, t) {
...
function jp(e, t) {
	...
	for (let i = 0; i < n.length; ++i) {
		...
		o.push({
			...
			pathnameBase: Ap(mt([l, p.pathnameBase])),
			route: h,
		}),
...
function Mp(e, t) {
	...
	return {
		params: r.reduce((a, p, h) => {
			let { paramName: m, isOptional: y } = p;
			if (m === '*') {
				let w = u[h] || '';
...
const eu = _.createContext(null),
	...
	Ut = _.createContext(null),
	zl = _.createContext(null),
	$t = _.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
	Fc = _.createContext(null);
function Yp(e, t) {
	let { relative: n } = t === void 0 ? {} : t;
	cr() || X(!1);
	let { basename: r, navigator: l } = _.useContext(Ut),
...
function cr() {
	return _.useContext(zl) != null;
}
function Tl() {
	return cr() || X(!1), _.useContext(zl).location;
}
function Uc(e) {
	_.useContext(Ut).static || _.useLayoutEffect(e);
}
function Xp() {
...
function Gp() {
	...
	let e = _.useContext(eu),
		{ basename: t, future: n, navigator: r } = _.useContext(Ut),
		{ matches: l } = _.useContext($t),
		{ pathname: o } = Tl(),
		i = JSON.stringify(jc(l, n.v7_relativeSplatPath)),
		u = _.useRef(!1);
	return (
		Uc(() => {
			u.current = !0;
		...
		_.useCallback(
			function (a, p) {
				...
				let h = Mc(a, JSON.parse(i), o, p.relative === 'path');
				e == null &&
					t !== '/' &&
...
function $c(e, t) {
	let { relative: n } = t === void 0 ? {} : t,
		{ future: r } = _.useContext(Ut),
		{ matches: l } = _.useContext($t),
		{ pathname: o } = Tl(),
		i = JSON.stringify(jc(l, r.v7_relativeSplatPath));
	return _.useMemo(() => Mc(e, JSON.parse(i), o, n === 'path'), [e, i, o, n]);
}
function Zp(e, t) {
	return Jp(e, t);
}
function Jp(e, t, n, r) {
	cr() || X(!1);
	let { navigator: l } = _.useContext(Ut),
	...
	if (t) {
		...
		s === '/' || ((h = E.pathname) != null && h.startsWith(s)) || X(!1),
			(p = E);
	} else p = a;
	let m = p.pathname || '/',
		y = m;
...
const bp = _.createElement(qp, null);
class eh extends _.Component {
	constructor(t) {
		super(t),
			(this.state = {
				location: t.location,
...
function nh(e, t, n, r) {
	...
	if (u != null) {
		let p = i.findIndex(
			(h) =>
				h.route.id && (u == null ? void 0 : u[h.route.id]) !== void 0,
		);
				...
				return (
					y
						...
						: g
							? (d = E)
							: h.route.Component
								? (d = _.createElement(h.route.Component, null))
								: h.route.element
									? (d = h.route.element)
									: (d = p),
					_.createElement(th, {
...
function sh(e) {
	...
	return w == null
		...
		: _.createElement(
				Ut.Provider,
				{ value: a },
				_.createElement(zl.Provider, { children: n, value: w }),
			);
}
function ah(e) {
...
function ri(e, t) {
	...
	return (
		_.Children.forEach(e, (r, l) => {
			...
			r.props.children && (i.children = ri(r.props.children, o)),
				n.push(i);
		}),
		n
	);
...
function vh(e) {
	...
	return (
		_.useLayoutEffect(() => i.listen(p), [i, p]),
		_.createElement(sh, {
			basename: t,
			children: n,
			location: u.location,
...
const yh =
	...
	zh = _.forwardRef(function (t, n) {
		let {
			...
			m = ch(t, ph),
			{ basename: y } = _.useContext(Ut),
			g,
			w = !1;
		if (typeof a == 'string' && gh.test(a) && ((g = a), yh))
			try {
...
const Sh = De.lazy(() =>
		kt(() => import('./Home-ChQkjNgz.js'), __vite__mapDeps([0, 1, 2])),
	),
	kh = De.lazy(() =>
		kt(
			() => import('./Chat-CUr8ITtm.js'),
			__vite__mapDeps([3, 4, 1, 5, 6]),
		),
	),
	Eh = De.lazy(() =>
		kt(
			() => import('./Game-CUSY7UDX.js'),
			__vite__mapDeps([7, 4, 1, 5, 8]),
		),
	),
	xh = De.lazy(() =>
		kt(
			() => import('./Custom-C6aLXnUB.js'),
			__vite__mapDeps([9, 4, 1, 5, 10]),
		),
	),
	Ch = De.lazy(() =>
		kt(
			() => import('./Profile-BPmPuw3m.js'),
			__vite__mapDeps([11, 4, 1, 5, 12]),
		),
	),
	_h = De.lazy(() =>
		kt(
			() => import('./Settings-BBqUS_G9.js'),
			__vite__mapDeps([13, 4, 1, 5, 14]),
		),
	),
	Ph = De.lazy(() =>
		kt(
			() => import('./Dashboard-BuvOrz8g.js'),
			__vite__mapDeps([15, 4, 1, 5, 16]),
		),
	),
	Nh = De.lazy(() => kt(() => import('./Tournament-SpOMH9wu.js'), []));
function Lh() {
	return V.jsx(vh, {
		children: V.jsx(De.Suspense, {
			fallback: V.jsx('div', { children: 'Loading...' }),
			children: V.jsxs(ah, {
				children: [
					V.jsx(Ve, { path: '/', element: V.jsx(Sh, {}) }),
					V.jsx(Ve, { path: '/Game', element: V.jsx(Eh, {}) }),
					V.jsx(Ve, { path: '/Chat', element: V.jsx(kh, {}) }),
					V.jsx(Ve, { path: '/Custom', element: V.jsx(xh, {}) }),
					V.jsx(Ve, { path: '/Profile', element: V.jsx(Ch, {}) }),
					V.jsx(Ve, { path: '/Settings', element: V.jsx(_h, {}) }),
					V.jsx(Ve, { path: '/Dashboard', element: V.jsx(Ph, {}) }),
					V.jsx(Ve, { path: '/Tournament', element: V.jsx(Nh, {}) }),
				],
			}),
		}),
	});
...
so.createRoot(document.getElementById('root')).render(
	V.jsx(De.StrictMode, { children: V.jsx(Lh, {}) }),
);
export { zh as L, De as R, Rh as c, Hc as g, V as j, _ as r };
