...
export default {
	...
	theme: {
		...
		extend: {
			...
			width: {
				'card-custom':
					'clamp(26.875rem, 26.0227rem + 4.5455vw, 33.125rem)',
				...
				'select-table':
					'clamp(28.875rem, 22.462vw + 20.312rem, 56.25rem)',

				'game-table-mtb':
					'clamp(26.25rem, 48.38vw + 13.218rem, 90.625rem)',

				'chart-lp': 'clamp(25rem, 19.531vw + 12.5rem, 43.75rem)',
				'chart-ms': 'clamp(18.625rem, 41.77vw + 10.793rem, 37.5rem)',

				'profile-cards':
					'clamp(57.75rem, 50.521vw + 25.417rem, 106.25rem)',
			...
			height: {
				...
				'profile-cards':
					'clamp(31.625rem, 27.669vw + 13.917rem, 58.188rem)',
				'signin-card-custom':
					'clamp(35rem, 7.727vw + 33.551rem, 45.625rem)',
				'signup-card-custom':
					'clamp(36.875rem, 9.545vw + 35.085rem, 50rem)',
				'1vs1-lg': 'clamp(11.063rem, 10.66vw + 1.468rem, 18.125rem)',
				'training-lg':
					'clamp(11.563rem, 10.849vw + 1.798rem, 18.75rem)',
				'tournaments-lg':
					'clamp(24.063rem, 22.83vw + 3.515rem, 39.188rem)',
				...
				'leftside-chat-ms':
					'clamp(10rem, 4.283vw + 9.197rem, 11.25rem)',
				'leftside-chat-tb':
					'clamp(9.375rem, 21.413vw + 5.36rem, 15.625rem)',

				'user-tb': 'clamp(3.5rem, 2.232vw + 2.429rem, 6rem)',

				profile:
					'clamp(31.64rem, 13.9246rem + 27.6803vw, 58.213125rem)',
			},
			padding: {
				...
				'user-info-x-ms':
					'clamp(0.313rem, 6.256vw - 0.861rem, 4.375rem)',
				'user-info-y-ms':
					'clamp(0.938rem, 2.887vw + 0.396rem, 2.813rem)',
				'user-info-t': 'clamp(3.125rem, 2.679vw + 0.714rem, 5rem)',

				// Chat Users
				'user-div-px-tb':
					'clamp(0.625rem, 1.116vw + 0.089rem, 1.875rem)',
			},
			margin: {
				// Game modes
				'modes-left-lg': 'clamp(0rem, 7.143vw - 8.929rem, 2.5rem)',
				'modes-right-lg':
					'clamp(0.313rem, 6.132vw - 5.206rem, 4.375rem)',
				'modes-left-ms': 'clamp(0.625rem, 3.304vw - 0.265rem, 2.5rem)',
				'modes-right-ms': 'clamp(0.625rem, 3.304vw - 0.265rem, 2.5rem)',

				// Profile Page
				'container-x-lp':
					'clamp(3.125rem, 33.929vw - 27.411rem, 26.875rem)',
