...
const TwoFactorAuth = React.lazy(
	() => import('../pages/TwoFactorAuth/TwoFactorAuth'),
);
...
const SearchingAnimation = React.lazy(
	() => import('../components/Game/Remote/SearchingAnimation'),
);

const MatchMaking = React.lazy(() => import('../components/Game/MatchMaking'));
const CustomTournament = React.lazy(
	() => import('../pages/CustomTournament/CustomTournament'),
);
const TournamentSetup = React.lazy(
	() => import('../pages/TournametSetup/TournametSetup'),
);
