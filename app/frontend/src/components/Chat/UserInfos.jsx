					...
					<div className='flex flex-col justify-center font-heavy lg:gap-y-8 tb:gap-y-5 gap-y-2'>
						...
						<div className='max-w-[500px]'>
							<p className='font-medium text-primary bio'>
								...
								quae corrupti ratione, esse quod amet quidem possimus necessitatibus
								optio cupiditate nisi placeat, nihil expedita sed quisquam. Commodi,
								cumque repellat. Lorem ipsum dolor sit amet, consectetur adipisicing
								elit.
							</p>
						</div>
					</div>
