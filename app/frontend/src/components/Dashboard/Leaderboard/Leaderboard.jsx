...
function Leaderboard() {
	return (
		...
		// 		<UserLeaderboard rank={1} nickname={'mouad5555vv5555555555555555'} achievement={'celestial master'} xp={12315}/>
		...
		// 		<UserLeaderboard rank={18} nickname={'mouad55fsdfdsfsdfsdfsdfsdf'} achievement={'cosmic explorer'} xp={3123}/>
