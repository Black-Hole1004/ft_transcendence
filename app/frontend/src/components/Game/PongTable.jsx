...
const [originalPaddleHeight, setOriginalPaddleHeight] = useState(80); // Set this to your original paddle height
  ...
  useEffect(() => {
    ...
    const updateGame = (time) => {
      ...
      if (isRightPlayerMovingDown) {
        setAiY(prev => Math.min(prev + paddleSpeed * deltaTime, canvasHeight - ai.height));
      }
  ...
  }, [isPaused, isGameOver, player, ai, updateScore, isLeftPlayerMovingUp, isLeftPlayerMovingDown, isRightPlayerMovingUp, isRightPlayerMovingDown, backgroundId]);
