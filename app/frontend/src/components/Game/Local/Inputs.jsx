		...
		<div className="flex-1 flex flex-col gap-2">
			...
			<div className="flex justify-between max-ml:flex-col max-ml:gap-2">
				<div className="flex flex-col flex-1 ml-2">
					<label
						className="font-regular text-light labels"
						htmlFor={id}
					>
						{id === 'Ball'
				...
				<div className="flex flex-col ml:w-[30%] w-[50%] max-ml:ml-2">
					...
					<MuiColorInput
						...
						onChange={(color) =>
							setValue(id === 'Ball' ? color : 'color', color)
						}
						sx={{
							// Border
							border: 1,
							...
							'& .MuiOutlinedInput-input': {
								...
								paddingTop:
									'clamp(0.375rem, 0.177vw + 0.342rem, 0.625rem)',
								paddingBottom:
									'clamp(0.375rem, 0.177vw + 0.342rem, 0.625rem)',
								paddingRight: '0px',
							},
							...
							'& .MuiOutlinedInput-root': {
								paddingLeft:
									'clamp(0.438rem, 0.221vw + 0.396rem, 0.75rem)',
								paddingRight:
									'clamp(0.438rem, 0.221vw + 0.396rem, 0.75rem)',
