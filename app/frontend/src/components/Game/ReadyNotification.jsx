...
const ReadyNotification = ({
	...
	return (
		...
		>
			...
			>
				<div
					className={`text-2xl font-bold mb-6 glow-text ${type === 'self' ? 'text-green-400' : 'text-blue-400'}`}
				>
				...
				<div className="text-lg mb-6 leading-relaxed">{message}</div>

				{type === 'self' && (
					<div className="text-gray-400 mb-6 p-4 bg-black bg-opacity-30 rounded-lg border border-gray-800">
						<p className="text-sm">
							Waiting for opponent to be ready and then you start
							the game...
						</p>
