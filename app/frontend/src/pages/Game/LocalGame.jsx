...
const GameOverPopup = ({ winner, onRestart, onClose }) => (
	<>
		...
		>
			{winner ? (
				<h1 className="font-dreamscape leading-none">
					VICTORY ACHIEVED
				</h1>
			) : (
				<h1 className="font-dreamscape leading-none">GAME OVER</h1>
			)}
			{winner ? (
				<div className="font-heavy">
					<p className="text-left">Cosmic Champion:</p>
					<h3 className="players-usernames font-dreamscape-sans pt-3 pb-7 text-center glow">
						{winner.name}
					</h3>
