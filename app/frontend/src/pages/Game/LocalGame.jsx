...
const GameOverPopup = ({ winner, onRestart, onClose }) => (
  <div className="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center z-50">
    <div className="bg-[#0E0B0A] border-2 border-[#76797Cff] text-[#E6DDC6] rounded-lg shadow-xl w-[480px] overflow-hidden relative">
      ...
      <div className="h-60 bg-[url('path/to/venus-pingpong-background.jpg')] bg-cover bg-center relative" 
           style={{ filter: 'brightness(1.2)' }}> {/* Increase brightness */}
      ...
      <div className="p-8 relative z-10">
        {winner ? (
          ...
          <p className="text-2xl text-center mb-6">A cosmic deadlock! The match ends in a tie.</p>
        )}
