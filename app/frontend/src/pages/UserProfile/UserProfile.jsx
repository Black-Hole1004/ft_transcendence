...
const GET_USER_PROFILE_BY_USERNAME = import.meta.env
	.VITE_GET_USER_PROFILE_BY_USERNAME;
...
const UserProfile = () => {
	...
	const fetchProfileStats = async () => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_BASE_URL}/api/user/profile/stats/${profile_name}/`,
				{
	...
	const fetchUserByUserName = async () => {
		try {
			const response = await fetch(
				`${GET_USER_PROFILE_BY_USERNAME}${profile_name}/`,
				{
					headers: getAuthHeaders(),
				},
			);
				...
				>
					...
					>
						<AboutSection
							...
							bio={user.bio}
							date_joined_formatted={user.date_joined_formatted}
						/>
