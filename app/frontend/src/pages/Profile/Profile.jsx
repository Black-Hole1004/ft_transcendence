		...
		<section ref={containerRef} className='flex justify-center'>
			...
			>
				...
				>
					...
					>
						<AboutSection first_name={user.first_name} last_name={user.last_name} email={user.email} mobile_number={user.mobile_number} username={user.username} bio={user.bio} date_joined_formatted={user.date_joined_formatted} />
