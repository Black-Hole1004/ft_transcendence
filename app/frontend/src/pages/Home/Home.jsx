		...
		<>
			<header className='relative flex items-center text-primary font-medium 2xl:h-[116px] xl:h-[100px] sm:h-[80px]'>
				<nav
					...
					<button className='responsive-font-header-buttons'>
						Sign in
					</button>
					<Button className='rounded-lg responsive-font-header-buttons
			...
			<section>
				...
				<div className='text-primary font-heavy text-center pt-[120px] tracking-wide leading-[1.7]'>
					...
					<Button className='responsive-font-getstarted-button rounded-xl mt-[25px]
