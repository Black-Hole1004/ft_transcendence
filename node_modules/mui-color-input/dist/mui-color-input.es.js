import { jsx as l, jsxs as ct, Fragment as kt } from "react/jsx-runtime";
import d from "react";
...
const $t = "linear-gradient(45deg, #ccc 25%, transparent 25%), linear-gradient(135deg, #ccc 25%, transparent 25%), linear-gradient(45deg, transparent 75%, #ccc 75%), linear-gradient(135deg, transparent 75%, #ccc 75%) /*! @noflip */", It = "linear-gradient(to top, #000000, transparent), linear-gradient(to right, #ffffff, transparent) /*! @noflip */", Bt = {
  Button: P(Ct)(() => ({
  ...
  return /* @__PURE__ */ l(
    Bt.Button,
    {
      ...
      style: {
        backgroundColor: i ? e : void 0,
        backgroundImage: i ? void 0 : $t,
  ...
  At,
  {
    ...
    ...n,
    children: /* @__PURE__ */ l(Pt.Container, { children: r })
  }
), Nt = {
  Slider: P(lt, {
  ...
  const { rgbColor: e, style: t, className: n, ...i } = r, s = {
    "--rgb-r": e.r,
    "--rgb-g": e.g,
    "--rgb-b": e.b,
    ...t
...
function Dt(r, e, t) {
  const n = r.getBoundingClientRect(), i = e - n.left, s = t - n.top;
  return {
    x: W(i / n.width, 0, 1),
...
const nt = {
  ...
  const { hsv: e, onChange: t, currentHue: n } = r, i = d.useRef(!1), s = d.useRef(null), [a, o] = d.useState(!1), u = Lt((b, k) => {
    if (!s.current)
      return;
    const { x: $, y: A } = Dt(s.current, b, k);
    t({
      s: $,
      v: A
    }), s.current && document.activeElement !== s.current && s.current.focus();
  }), w = d.useCallback(() => {
    i.current && (i.current = !1, o(!1));
  }, []), p = d.useCallback((b) => {
    i.current && u(b.clientX, b.clientY);
  }, []);
  d.useEffect(() => (document.addEventListener("pointermove", p, !1), document.addEventListener("pointerup", w, !1), () => {
    document.removeEventListener("pointermove", p, !1), document.removeEventListener("pointerup", w, !1);
  }), [w, p]);
  const m = (b) => {
    b.preventDefault(), i.current = !0, u(b.clientX, b.clientY), o(!0);
  }, y = (b) => {
    if (Ot(b.key)) {
      b.preventDefault();
      const { type: k, value: $ } = Tt[b.key], A = b.shiftKey ? 10 : 1, T = k === "hsvS" ? e.s : e.v, E = W(
        T + $ * A * 0.01,
        0,
        1
      );
    ...
    nt.Space,
    {
      ...
      children: /* @__PURE__ */ l(
        nt.Thumb,
        {
          ...
          className: a ? "MuiColorInput-Thumb-active" : "",
          style: {
            left: `${M}%`,
            bottom: `${H}%`
          }
...
function st(r, e, t) {
  ...
  const n = Math.max(r, e, t), i = Math.min(r, e, t);
  let s = 0, a = 0;
  const o = (n + i) / 2;
  if (n === i)
    a = 0, s = 0;
    ...
    const u = n - i;
    switch (a = o > 0.5 ? u / (2 - n - i) : u / (n + i), n) {
      case r:
        s = (e - t) / u + (e < t ? 6 : 0);
        break;
      case e:
...
function Yt(r, e, t) {
  ...
  if (r = g(r, 360), e = g(e, 100), t = g(t, 100), e === 0)
    ...
    const a = t < 0.5 ? t * (1 + e) : t + e - t * e, o = 2 * t - a;
    n = Y(o, a, r + 1 / 3), i = Y(o, a, r), s = Y(o, a, r - 1 / 3);
  }
...
function Xt(r, e, t) {
  ...
  const n = Math.floor(r), i = r - n, s = t * (1 - e), a = t * (1 - i * e), o = t * (1 - (1 - i) * e), u = n % 6, w = [t, a, s, s, o, t][u], p = [o, t, t, a, s, s][u], m = [s, s, o, t, t, a][u];
  return { r: w * 255, g: p * 255, b: m * 255 };
}
function at(r, e, t, n) {
  const i = [
...
function Jt(r, e, t, n) {
  const i = r / 100, s = e / 100, a = t / 100, o = n / 100, u = 255 * (1 - i) * (1 - o), w = 255 * (1 - s) * (1 - o), p = 255 * (1 - a) * (1 - o);
  return { r: u, g: w, b: p };
}
function ot(r, e, t) {
  let n = 1 - r / 255, i = 1 - e / 255, s = 1 - t / 255, a = Math.min(n, i, s);
  return a === 1 ? (n = 0, i = 0, s = 0) : (n = (n - a) / (1 - a) * 100, i = (i - a) / (1 - a) * 100, s = (s - a) / (1 - a) * 100), a *= 100, {
    c: Math.round(n),
    m: Math.round(i),
    y: Math.round(s),
    k: Math.round(a)
...
const ee = "[-\\+]?\\d+%?", re = "[-\\+]?\\d*\\.\\d+%?", C = "(?:" + re + ")|(?:" + ee + ")", X = "[\\s|\\(]+(" + C + ")[,|\\s]+(" + C + ")[,|\\s]+(" + C + ")\\s*\\)?", q = (
...
function ne(r) {
  ...
  let t = v.rgb.exec(r);
  return t ? { r: t[1], g: t[2], b: t[3] } : (t = v.rgba.exec(r), t ? { r: t[1], g: t[2], b: t[3], a: t[4] } : (t = v.hsl.exec(r), t ? { h: t[1], s: t[2], l: t[3] } : (t = v.hsla.exec(r), t ? { h: t[1], s: t[2], l: t[3], a: t[4] } : (t = v.hsv.exec(r), t ? { h: t[1], s: t[2], v: t[3] } : (t = v.hsva.exec(r), t ? { h: t[1], s: t[2], v: t[3], a: t[4] } : (t = v.cmyk.exec(r), t ? {
    c: t[1],
    m: t[2],
    y: t[3],
    k: t[4]
...
class h {
  ...
  getLuminance() {
    const e = this.toRgb();
    let t, n, i;
    const s = e.r / 255, a = e.g / 255, o = e.b / 255;
    return s <= 0.03928 ? t = s / 12.92 : t = Math.pow((s + 0.055) / 1.055, 2.4), a <= 0.03928 ? n = a / 12.92 : n = Math.pow((a + 0.055) / 1.055, 2.4), o <= 0.03928 ? i = o / 12.92 : i = Math.pow((o + 0.055) / 1.055, 2.4), 0.2126 * t + 0.7152 * n + 0.0722 * i;
  }
  /**
   ...
   */
  toHsvString() {
    const e = it(this.r, this.g, this.b), t = Math.round(e.h * 360), n = Math.round(e.s * 100), i = Math.round(e.v * 100);
    return this.a === 1 ? `hsv(${t}, ${n}%, ${i}%)` : `hsva(${t}, ${n}%, ${i}%, ${this.roundA})`;
  }
  /**
   * Returns the object as a HSLA object.
   */
  toHsl() {
    const e = st(this.r, this.g, this.b);
   ...
   */
  toHslString() {
    const e = st(this.r, this.g, this.b), t = Math.round(e.h * 360), n = Math.round(e.s * 100), i = Math.round(e.l * 100);
    return this.a === 1 ? `hsl(${t}, ${n}%, ${i}%)` : `hsla(${t}, ${n}%, ${i}%, ${this.roundA})`;
  }
  /**
   ...
   */
  toHex8(e = !1) {
    return Zt(this.r, this.g, this.b, this.a, e);
  }
  /**
  ...
  toCmyk() {
    return {
      ...ot(this.r, this.g, this.b)
    };
  }
  toCmykString() {
    const { c: e, m: t, y: n, k: i } = ot(this.r, this.g, this.b);
    return `cmyk(${e}, ${t}, ${n}, ${i})`;
  }
  /**
  ...
  toString(e) {
    ...
    return !t && i && (e.startsWith("hex") || e === "name") ? e === "name" && this.a === 0 ? this.toName() : this.toRgbString() : (e === "rgb" && (n = this.toRgbString()), e === "prgb" && (n = this.toPercentageRgbString()), (e === "hex" || e === "hex6") && (n = this.toHexString()), e === "hex3" && (n = this.toHexString(!0)), e === "hex4" && (n = this.toHex8String(!0)), e === "hex8" && (n = this.toHex8String()), e === "name" && (n = this.toName()), e === "hsl" && (n = this.toHslString()), e === "hsv" && (n = this.toHsvString()), e === "cmyk" && (n = this.toCmykString()), n || this.toHexString());
  }
  toNumber() {
   ...
   */
  mix(e, t = 50) {
    const n = this.toRgb(), i = new h(e).toRgb(), s = t / 100, a = {
      r: (i.r - n.r) * s + n.r,
      g: (i.g - n.g) * s + n.g,
      b: (i.b - n.b) * s + n.b,
      a: (i.a - n.a) * s + n.a
  ...
  analogous(e = 6, t = 30) {
    const n = this.toHsl(), i = 360 / t, s = [this];
    for (n.h = (n.h - (i * e >> 1) + 720) % 360; --e; )
      n.h = (n.h + i) % 360, s.push(new h(n));
    return s;
  }
  /**
  ...
  monochromatic(e = 6) {
    const t = this.toHsv(), { h: n } = t, { s: i } = t;
    let { v: s } = t;
    const a = [], o = 1 / e;
    for (; e--; )
      a.push(new h({ h: n, s: i, v: s })), s = (s + o) % 1;
    return a;
  }
  splitcomplement() {
   ...
   */
  onBackground(e) {
    const t = this.toRgb(), n = new h(e).toRgb(), i = t.a + n.a * (1 - t.a);
    return new h({
   ...
   */
  polyad(e) {
    const t = this.toHsl(), { h: n } = t, i = [this], s = 360 / e;
    for (let a = 1; a < e; a++)
      i.push(new h({ h: (n + a * s) % 360, s: t.s, l: t.l }));
    return i;
  }
  /**
...
function se(r) {
  return Wt(r) ? r : new h(r).toString();
}
const ie = (r) => {
  const { currentColor: e, format: t, onChange: n, isAlphaHidden: i } = r, [s, a] = d.useState(
    e.toHsv()
  ), o = (p, m) => {
    if (!et(m))
      return;
  ...
  return /* @__PURE__ */ ct(z, { className: "MuiColorInput-PopoverBody", children: [
    ...
    /* @__PURE__ */ l(z, { mt: "10px", px: "3px", children: /* @__PURE__ */ l(
      qt,
      {
        min: 0,
        max: 100,
    ...
    i ? null : /* @__PURE__ */ l(z, { mt: "10px", px: "3px", children: /* @__PURE__ */ l(
      Vt,
      {
        min: 0,
        max: 1,
...
function ft(r, e) {
  typeof e == "function" ? e(r) : e && he(e) && "current" in e && (e.current = r);
}
function xe(r) {
...
const Se = d.forwardRef(
  ({
    ...
    const { onBlur: m, slotProps: y, ...M } = w, { onClose: H, ...b } = i || {}, k = M.disabled || !1, $ = d.useRef(null), A = d.useRef(null), [T, E] = d.useState(null), I = e || oe, K = ut(r, {
      format: I
    }), [O, N] = d.useState(r), [J, V] = d.useState(r), gt = (f) => {
      f.preventDefault(), f.stopPropagation(), !k && !u && E($.current);
    }, D = (f) => {
      const c = new h(f);
      t?.(f, {
        hex: c.isValid ? c.toHexString() : "",
        hsv: c.isValid ? c.toHsvString() : "",
        hsl: c.isValid ? c.toHslString() : "",
        rgb: c.isValid ? c.toRgbString() : "",
        hex8: c.isValid ? c.toHex8String() : ""
      });
    }, bt = (f) => {
      ...
      if (N(c), c === "")
        ...
        const U = new h(c), B = F(U, I);
        V(B), D(B);
      }
    }, pt = (...f) => {
      H?.(...f), E(null), queueMicrotask(() => {
        A.current?.focus();
      });
    }, mt = (f) => {
      m?.(f);
    ...
    const xt = (f) => {
      ...
      A.current = f, ft(f, A);
    }, Q = !!T, _ = Q ? "color-popover" : void 0, tt = /* @__PURE__ */ l(Ht, { position: n, children: /* @__PURE__ */ l(
      s,
      {
        disabled: k,
        "aria-describedby": _,
      ...
      startAdornment: n === "start" ? tt : void 0,
      endAdornment: n === "end" ? tt : void 0,
      ...wt
    };
    return /* @__PURE__ */ ct(kt, { children: [
      /* @__PURE__ */ l(
        ae,
        {
          ref: St,
...
export {
  Se as MuiColorInput,
  Ft as MuiColorInputButton,
  xe as matchIsValidColor
};
